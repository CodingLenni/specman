...
public class SubsequenceStepModel_V002 extends StructuredStepModel_V002 {
    ...
    public SubsequenceStepModel_V002(String id, String stepNumber, EditorContentModel_V002 content, Integer shade, ChangeInfo changeInfo, boolean collapsed, StepSequenceModel_V002 subsequence, String sourceStepId, RoundedBorderDecorationStyle decorationStyle, boolean flatNumbering) {
